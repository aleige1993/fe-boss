...
<!--审批信息列表（放款管理）-->
  <div id="table-loan-approval-info">
    <i-table :height="tableFixHeight" :current="currentPageExamine" :loading="examineTableLoading" border ref="examineTable" :columns="examineColumns" :data="examineData"></i-table>
