...
<!--合同模板列表模态框-->
  <div id="table-contractTemplate-list">
    ...
    <i-table :height="(type==='page')?tableFixHeight:''" border :page-size="pageSize" :loading="dataLoading" ref="contractTemplateTable" :columns="resultColumns" :data="data1" @on-row-dblclick="selectRow"></i-table>
