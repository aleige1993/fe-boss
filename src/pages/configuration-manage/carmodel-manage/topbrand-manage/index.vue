<template>
  <div id="page-table-demo">
    ...
    <i-table :height="this.$store.getters.viewHeight+40" border :loading="dataLoading" ref="selection" @on-select="selectRow" :columns="resultCustomerColumns" :data="privateCustomerLoanList"></i-table>
