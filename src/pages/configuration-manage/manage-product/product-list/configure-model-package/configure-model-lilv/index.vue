  ...
  <div id="conf-model-lilv">
    ...
    <bs-modal :title="'资方利率'" v-model="zfLilvModel" :width="1200">
      <div>
        ...
        <i-table :height="tableFixHeight + 98" :loading="ZFLVdataLoading" border ref="zfTable" :columns="columnsZFLV" :data="dataZFLV"></i-table>
      </div>
    </bs-modal>
    <!--选择资方的弹窗-->
    ...
    <bs-modal title="新增" v-model="showCostModel" :width="1200">
      ...
      <i-table :height="tableFixHeight + 98" :loading="costDataLoading" border ref="FyTable" :columns="costcolumns" :data="costdata"></i-table>
    </bs-modal>
