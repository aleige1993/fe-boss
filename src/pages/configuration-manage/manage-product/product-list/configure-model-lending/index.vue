...
<div id="configure-model-lending">
  <i-table :height="this.$store.getters.viewHeight + 98" :loading="dataLoading" border ref="lendingTable" :columns="columns1" :data="data1" @on-selection-change="selectRow"></i-table>
  <br>
  <br>
