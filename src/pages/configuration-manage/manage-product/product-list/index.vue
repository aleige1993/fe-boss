<template>
  <div id="page-product">
    ...
    <i-table :height="tableFixHeight" highlight-row border :loading="dataLoading" ref="proTable" :columns="resultColumns" :data="data1" @on-current-change="radioFun" @on-row-dblclick="selectRow"></i-table>
    ...
    <pt-modal :title="isAdd ? '新增' : '修改'" v-model="showAddModal" :width="1200">
      <i-form v-if="showAddModal" ref="formCustom" :model="formCustom" label-position="right" :label-width="120">
        ...
        <bs-form-block :title="'产品特性'" v-if="!isAdd">
          ...
          <i-table :height="tableFixHeight-200" :loading="tabelFeatureLoading" border ref="tableFeature" :columns="columnsFeature" :data="dataFeature"></i-table>
        </bs-form-block>
