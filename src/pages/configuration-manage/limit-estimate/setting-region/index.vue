<template>
  <div id="page-table-demo">
    ...
    <i-table :height="tableFixHeight+80" border :loading="dataLoading" ref="selection" @on-select="selectRow" :columns="resultCustomerColumns" :data="privateCustomerLoanList"></i-table>
