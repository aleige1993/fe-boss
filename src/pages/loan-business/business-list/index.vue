<template>
  <div id="page-table-demo">
    ...
    <i-table :height="this.$store.getters.viewHeight" :loading="dataLoading" @on-row-dblclick="selectRow" border ref="selection" :columns="resultCustomerColumns" :data="privateCustomerLoanList"></i-table>
