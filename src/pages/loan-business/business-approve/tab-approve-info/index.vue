      ...
      <i-col span="24">
        <i-form label-position="right" ref="busApproveForm" :model="approveData" :label-width="140">
          ...
          <bs-form-block :title="'用信方案'">
            ...
            <i-row>
              <i-col span="8">
                <i-form-item label="产品利率" prop="loanApproveCreditDTO.loanNominalRate"
              ...
              <i-col span="8">
                <i-form-item label="放款方式" prop="loanApproveCreditDTO.loanMode"
                  ...
                  <i-select :disabled="isApprove||readonly" @on-change="getBankList" v-model="approveData.loanApproveCreditDTO.loanMode">
  ...
  export default {
    ...
    methods: {
      ...
      getPageInitData() {
        ...
        this.getLoanPeriodByProductNo(this.applyBasicInfo.productPackageNo, this.applyBasicInfo.custLevel);
