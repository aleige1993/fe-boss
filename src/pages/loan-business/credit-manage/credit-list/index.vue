<template>
  <div id="page-credit-list">
    ...
    <i-table :height="tableFixHeight+48" :loading="dataLoading" @on-row-dblclick="selectRow" border ref="selection" :columns="resultCustomerColumns" :data="privateCustomerList"></i-table>
