  ...
  <div id="" style="position:relative">
    ...
    <i-tabs v-model="tabIndex" :animated="false" type="card" @on-click="tabChange">
      ...
      <i-tab-pane :disabled="spouseDisabled" label="配偶信息">
        <tab-spouse-info :customer="addCustomer" :isFromDetail="isFromDetail"></tab-spouse-info>
      </i-tab-pane>
      <i-tab-pane :disabled="otherDisabled" label="联系人信息">
        <tab-contact-info :customer="addCustomer" :isFromDetail="isFromDetail"></tab-contact-info>
      </i-tab-pane>
      <i-tab-pane :disabled="otherDisabled" label="银行账户信息">
        <tab-bank-account-info :customer="addCustomer" :isFromDetail="isFromDetail"></tab-bank-account-info>
      </i-tab-pane>
      <i-tab-pane :disabled="otherDisabled" label="征信信息">
        <tab-credit-info :customer="addCustomer" :isFromDetail="isFromDetail"></tab-credit-info>
      </i-tab-pane>
      <i-tab-pane :disabled="otherDisabled" label="旗下公司">
        <tab-owe-company-info :customer="addCustomer" :isFromDetail="isFromDetail"></tab-owe-company-info>
      </i-tab-pane>
      <i-tab-pane :disabled="otherDisabled" label="负面调查">
        <tab-negative-survey-info :customer="addCustomer" :isFromDetail="isFromDetail"></tab-negative-survey-info>
      </i-tab-pane>
      <i-tab-pane :disabled="otherDisabled" label="大数据信息">
        <tab-business-contact-info :customer="addCustomer" :isFromDetail="isFromDetail"></tab-business-contact-info>
      </i-tab-pane>
      <i-tab-pane :disabled="otherDisabled" label="诉讼情况">
        <tab-lawsuit-info :customer="addCustomer" :isFromDetail="isFromDetail"></tab-lawsuit-info>
      </i-tab-pane>
    </i-tabs>
  </div>
</template>
