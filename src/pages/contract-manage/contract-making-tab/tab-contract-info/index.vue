      ...
      <i-row>
        ...
        <i-col span="8">
          <i-form-item
            ...
            prop="carOwnerName">
            <input type="hidden" v-model="setCarDataForm.carOwnerNo"/>
            <i-input v-model="setCarDataForm.carOwnerName" placeholder=""/>
          </i-form-item>
        </i-col>
        <i-col span="8">
          <i-form-item label="证件类型" prop="guaPersonType">
            ...
            <!--</i-option>-->
            <!--</i-select>-->
            <span v-text="setCarDataForm.custType === '2' ? '营业执照' : '身份证'"></span>
          </i-form-item>
        </i-col>
        <i-col span="8">
          <!--<i-form-item-->
          ...
          <!--</i-form-item>-->
          <i-form-item v-if="setCarDataForm.custType === '1'" label="证件号码" prop="carOwnerNumber"
                       :rules="[{required: true, message: '证件号码不能为空'},
                                  {required: true, min: 18, message: '请输入正确的证件号码'},
                                  {required: true, max: 18, message: '请输入正确的证件号码'}]">
            <i-input v-model="setCarDataForm.carOwnerNumber"/>
          </i-form-item>
