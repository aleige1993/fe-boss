...
<!--放款申请列表-->
  <div id="page-loan-GPS-list">
    <i-breadcrumb separator=">">
      ...
      <i-breadcrumb-item>GPS安装落实</i-breadcrumb-item>
    </i-breadcrumb>
    ...
    <i-table :loading="dataLoading" border ref="tableData" :columns="GPSListColumns" :data="GPSListData"></i-table>
